...
Also, the SDcard-SPI decoder in libsigrokdecode was completly broken for me. (it always expected a CRC...) My fix was to make [my own custom version of the decoder](https://github.com/liaminventions/XPL-32/tree/main/debug)
